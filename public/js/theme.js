    ...
    if (siteKey) {
      ...
      grecaptcha.ready(function () {
        grecaptcha.execute(siteKey, {
          ...
          $form.data('grecaptcha-token', token).append("<input type=\"hidden\" name=\"_grecaptcha_token\" value=\"".concat(token, "\" />")).submit();
        });
      });
    } else {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/theme"], () => (__webpack_require__("./resources/sass/theme.sass")))
